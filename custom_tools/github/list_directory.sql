/*
===============================================================================
GITHUB DIRECTORY LISTER - GraphQL API Version
===============================================================================

PURPOSE:
Lists files and directories in a GitHub repository path using the GraphQL API.
Provides detailed information about repository structure including file sizes,
types, and directory contents count.

KEY FEATURES:
- Uses GitHub GraphQL API for efficient data fetching
- Returns structured JSON with file and directory information
- Handles authentication and rate limiting gracefully
- Supports browsing any public or accessible private repository
- Provides file metadata including size and binary status

USAGE:
- GITHUB_DIRECTORY_LISTER: List repository contents at specified path
...
- [SECTION_4_OUTPUT]       : Output structure documentation
